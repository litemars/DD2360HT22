...
int main(int argc, char **argv) {
  ...
  cudaHostAlloc((DataType**)&hostA,numARows * numAColumns * sizeof(DataType),cudaHostAllocDefault);
  cudaHostAlloc((DataType**)&hostB,numBRows * numBColumns * sizeof(DataType),cudaHostAllocDefault);
  cudaHostAlloc((DataType**)&hostC,numCRows * numCColumns * sizeof(DataType),cudaHostAllocDefault);
